...
- 👯 I’m looking to collaborate on ...you tell me your interests and maybe there is something shared- life is partly improvisation. I also have a blue sky research idea that would cost over $50 million, if you're interested. To clarify, this money would be exclusively allocated to software and hardware engineers (Not me).
...
- 😄 Pronouns: ...he/him
- ⚡ Fun fact: ...My definition of fun might be a little [different](https://www.reddit.com/r/gonzo/comments/ao4lvl/warren_zevon_reads_fax_written_by_hunter_s/) than yours
...
Thinking about this, it seemed practical to combine certain memetic concepts, even if they were "meta-meme." But on the other hand, much of the internet social media platforms are memetic- the rise of Microsoft and Apple in the 1980s, to the rise of software companies in the 90s- Google, Facebook, Twitter, Instagram, and TikTok. Thus the concept of memes are not necessarily lost on everyone. But when a concept becomes so widespread, it also becomes ripe for identifying imperfections or amusing aspects of large Elephants hiding in plain sight. It can also be used to make commentary on the permanence of memes as a cultural abstraction layer to genes and more hard-coded customs/more. 

So, why combine Mr. Trololol and cats? Well, Mr. Trolol is considered the "Russian Rickroll":  https://en.wikipedia.org/wiki/Eduard_Khil
